...
# Учебные группы
Учебная группа - _тут должно быть определение про группу лиц и прочее и про упорядочивание учебного процесса_
...
По решению руководства организации группа может быть расформирована, несмотря на то, что период активности ещё не закончился.
...
## Роль политики оценивания в проверке работ
_текст_

## Автоматическая проверка работ
_блок-схема алгоритма проверки_
