...
|Идентификатор и название варианта использования|UC-1.1.12 Просмотр списка вопросов в тесте (для составителей)|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.13 Просмотр информации об отдельном вопросе (для составителей)|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.14 Удаление вопроса из теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.15 Изменение порядка вопросов в тесте|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.16 Редактирование вопроса|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.17 Создание новой редакции теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.18 Настройка способа проверки работ|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.19 Настройка распределения баллов за вопросы|
|---|---|
|Основное действующее лицо|Преподаватель|
|Условие-триггер|Пользователь выбирает функцию "Настроить режим проверки"|
|Предварительные условия|<ol><li>Пользователь авторизован в системе как преподаватель;</li><li>Пользователь должен быть автором или составителем теста.</li></ol>|
