...
<!--ToDo сослаться сюда из юзкейсов администратора-->
|Идентификатор и название варианта использования|UC-1.1.2 Просмотр информации о тесте (для составителей)|
|---|---|
...
|Идентификатор и название варианта использования|UC-1.1.3 Просмотр списка рабочих тестов (для преподавателей)|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.4 Изменение названия или темы теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.5 Изменение порядка прохождения вопросов теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.6 Настройка возможности повторно отправлять ответы на вопросы|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.7 Задание лимита времени на тест|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.8 Изменение числа попыток сдачи теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.9 Выбор политики оценивания ответов в тесте|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.10 Задание проходного балла для сдачи теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.11 Отправка заявки на публикацию теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.12 Добавление вопроса в тест|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.13 Просмотр списка вопросов в тесте (для составителей)|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.14 Просмотр информации об отдельном вопросе (для составителей)|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.15 Удаление вопроса из теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.16 Изменение порядка вопросов в тесте|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.17 Редактирование вопроса|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.18 Создание новой редакции теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.19 Настройка способа проверки работ|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.20 Настройка распределения баллов за вопросы|
|---|---|
|Основное действующее лицо|Преподаватель|
|Условие-триггер|Пользователь выбирает функцию "Настроить режим проверки"|
|Предварительные условия|<ol><li>Пользователь авторизован в системе как преподаватель;</li><li>Пользователь должен быть автором или составителем теста.</li></ol>|
