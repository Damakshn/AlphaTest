...
|Идентификатор и название варианта использования|UC-1.1.4 Изменение порядка прохождения вопросов теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|[Нумерация вопросов](/docs/BusinessRules.md/#QuestionNumbers), [Перестановка вопросов](/docs/BusinessRules.md/#QuestionRenumeration), [Порядок ответов на вопросы в тесте](/docs/BusinessRules.md/#TestFlowQuestionOrder), [Редактирование тестов](/docs/BusinessRules.md/#TestEditing)|

|Идентификатор и название варианта использования|UC-1.1.5 Настройка возможности повторно отправлять ответы на вопросы|
|---|---|
|Основное действующее лицо|Преподаватель|
...
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|[Повторные ответы](/docs/BusinessRules.md/#TestFlowRevokeAnswers), [Повторные ответы - ограничения](/docs/BusinessRules.md/#TestFlowRevokeAnswersRestrictions), [Редактирование тестов](/docs/BusinessRules.md/#TestEditing)|

|Идентификатор и название варианта использования|UC-1.1.6 Задание лимита времени на тест|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.9 Задание проходного балла для сдачи теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.11 Добавление вопроса в тест|
|---|---|
|Основное действующее лицо|Преподаватель|
...
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|[Удаление вопросов](/docs/BusinessRules.md/#RemovingQuestionFromTest), [Пересчёт нумерации вопросов](/docs/BusinessRules.md/#QuestionNumbersConsistensy), [Редактирование тестов](/docs/BusinessRules.md/#TestEditing)|

|Идентификатор и название варианта использования|UC-1.1.13 Изменение порядка вопросов в тесте|
|---|---|
|Основное действующее лицо|Преподаватель|
...
||Система выводит пользователю сообщение об ошибке и предлагает попытаться снова.|
|Бизнес-правила|[Перестановка вопросов](/docs/BusinessRules.md/#QuestionRenumeration), [Пересчёт нумерации вопросов](/docs/BusinessRules.md/#QuestionNumbersConsistensy), [Редактирование тестов](/docs/BusinessRules.md/#TestEditing)|

|Идентификатор и название варианта использования|UC-1.1.14 Редактирование вопроса|
|---|---|
|Основное действующее лицо|Преподаватель|
...
||**Другой пользователь, имеющий права на редактирование теста, уже изменил вопрос и возник конфликт правок**|
||Система выводит пользователю сообщение об ошибке и предлагает попытаться снова.|
|Бизнес-правила|[Редактирование вопросов](/docs/BusinessRules.md/#EditingQuestions), [Ограничения атрибутов вопроса](/docs/BusinessRules.md/#QuestionAttributesRestrictions), [Редактирование тестов](/docs/BusinessRules.md/#TestEditing)|

|Идентификатор и название варианта использования|UC-1.1.15 Создание новой редакции теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Бизнес-правила|[Создание и публикация новой версии](/docs/BusinessRules.md/#NewEditionOfTest), [Ограничения для создания новых версий тестов](/docs/BusinessRules.md/#NewEditionRestrictions), [Списание тестов в архив](/docs/BusinessRules.md/#TestArchiving), [Редактирование тестов](/docs/BusinessRules.md/#TestEditing)|
...
||Система выводит пользователю сообщение о недопустимой операции.|
|Бизнес-правила|[Способы проверки работ](/docs/BusinessRules.md/#TestCheckingMethod), [Ограничения автоматической проверки](/docs/BusinessRules.md/#AutomatedCheckingRestrictions), [Смешанная проверка](/docs/BusinessRules.md/#MixedCheckingMethod), [Редактирование тестов](/docs/BusinessRules.md/#TestEditing)|

|Идентификатор и название варианта использования|UC-1.1.17 Настройка распределения баллов за вопросы|
|---|---|
|Основное действующее лицо|Преподаватель|
|Условие-триггер|Пользователь выбирает функцию "Настроить режим проверки"|
|Предварительные условия|<ol><li>Пользователь авторизован в системе как преподаватель;</li><li>Пользователь должен быть автором или составителем теста.</li></ol>|
...
||**Другой пользователь, имеющий права на редактирование теста, уже внёс изменения и возник конфликт правок**|
||Система выводит пользователю сообщение об ошибке и предлагает попытаться снова.|
|Бизнес-правила|[Распределение баллов за вопросы](/docs/BusinessRules.md/#TestCheckingScoreDistribution), [Автоматическое распределение](/docs/BusinessRules.md/#AutomaticScoreDistribution), [Распределение вручную](/docs/BusinessRules.md/#ManualScoreDistribution), [Редактирование тестов](/docs/BusinessRules.md/#TestEditing), [Добавление вопросов со стандартным баллом](/docs/BusinessRules.md/#AddingQuestionsWithUnifiedScore)|

### 1.2 Управление доступом к тесту
|Идентификатор и название варианта использования|UC-1.2.1 Просмотр списка составителей теста|
|---|---|
|Основное действующее лицо|Преподаватель|
|Условие-триггер|Пользователь выбирает функцию "Список составителей"|
|Предварительные условия|<ol><li>Пользователь авторизован в системе как преподаватель;</li><li>Пользователь должен быть автором теста.</li></ol>|
|Выходные условия|Система выводит список преподавателей, являющихся составителями выбранного теста. Автор теста в список не включается.|
|Бизнес-правила|[Автор теста](/docs/BusinessRules.md/#WhoCanCreate), [Составитель теста](/docs/BusinessRules.md/#WhoIsContributor)|

|Идентификатор и название варианта использования|UC-1.2.2 Добавление другого преподавателя в список составителей|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.2.3 Исключение другого преподавателя из списка составителей|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.2.4 Передача теста другому преподавателю|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-2.1.2 Просмотр списка пользователей|
|---|---|
|Основное действующее лицо|Администратор|
|Условие-триггер|Пользователь выбирает функцию "Пользователи"|
|Предварительные условия|Пользователь авторизован в системе как администратор.|
|Выходные условия|Система выводит постраничный список всех зарегистрированных пользователей с возможностью фильтрации, поиска и сортировки.|
|Дополнительно|Доступна фильтрация:<ul><li>По ролям доступа;</li><li>По ФИО;</li><li>По статусу (заблокирован или нет);</li><li>По email;</li><li>По учебным группам (для студентов).</li></ul>|
...
|Идентификатор и название варианта использования|UC-2.1.3 Массовый импорт сведений об учащихся|
|---|---|
|Основное действующее лицо|Администратор|
...
|Идентификатор и название варианта использования|UC-2.1.4 Назначение ролей доступа для пользователей **TBD**|
|---|---|
|Основное действующее лицо|Администратор|
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|[Роли доступа](/docs/BusinessRules.md/#AccessRoles)|

|Идентификатор и название варианта использования|UC-2.1.5 Блокировка учётной записи|
|---|---|
|Основное действующее лицо|Администратор|
...
|Идентификатор и название варианта использования|UC-2.1.6 Повторная генерация временного пароля|
|---|---|
|Основное действующее лицо|Администратор|
...
|Идентификатор и название варианта использования|UC-2.1.7 Передача теста другому автору|
|---|---|
|Основное действующее лицо|Администратор|
...
|Идентификатор и название варианта использования|UC-2.1.8 Передача полномочий экзаменатора|
|---|---|
|Основное действующее лицо|Администратор|
...
|Идентификатор и название варианта использования|UC-2.1.9 Просмотр информации об учётной записи пользователя|
|---|---|
|Основное действующее лицо|Администратор|
|Условие-триггер|Пользователь выбирает функцию "Просмотр профиля".|
|Предварительные условия|Пользователь авторизован в системе как администратор.|
|Выходные условия|Система выводит информацию о профиле выбранного пользователя в системе.|
|Дополнительно|Администратору доступна следующая информация о пользователе:<ul><li>ФИО;</li><li>E-mail;</li><li>Статус временного пароля (сменён или нет);</li><li>Временный пароль;</li><li>Статус пользователя: (заблокирован или нет);</li><li>Текущие роли доступа;</li><li>Дата и время последнего входа в систему.</li></ul>|
|Бизнес-правила||
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|[Учебные группы](/docs/BusinessRules.md/#StudyGroups), [Обработка данных о группах](/docs/BusinessRules.md/#WhoCanWorkWithGroups), [Членство в группе](/docs/BusinessRules.md/#GroupMembership), [Уведомление учащихся](/docs/BusinessRules.md/#NotificationsForStudents)|
...
|Идентификатор и название варианта использования|UC-2.3.4 Рассмотрение заявки на публикацию теста|
|---|---|
|Основное действующее лицо|Администратор|
...
### 2.4 Работа с тестами
|Идентификатор и название варианта использования|UC-2.4.1 Просмотр списка рабочих тестов (для администратора)|
|---|---|
|Основное действующее лицо|Администратор|
|Условие-триггер|Пользователь выбирает функцию "Список тестов"|
|Предварительные условия|Пользователь авторизован в системе как администратор.|
|Выходные условия|Система выводит постраничный список всех тестов с возможностью фильтрации, поиска и сортировки содержимого. По умолчанию выводятся только неархивные тесты.|
|Бизнес-правила|[Тест](/docs/BusinessRules.md/#Testmaking), [Статусы теста](/docs/BusinessRules.md/#TestStatus)|

## 3. Учащийся
### 3.1 Сдача тестов
|Идентификатор и название варианта использования|UC-3.1.1 Просмотр индивидуального расписания экзаменов|
|---|---|
|Основное действующее лицо|Учащийся|
|Условие-триггер|Пользователь выбирает функцию "Моё расписание"|
|Предварительные условия|Пользователь авторизован в системе как учащийся.|
|Выходные условия|Система выводит список экзаменов, доступных учащемуся для сдачи в данный момент.|
|Дополнительно|Для каждого экзамена выводится следующая информация: сведения о тесте (название, тема, версия), экзаменатор, количество попыток, лимит времени на тест (если есть), время до окончания экзамена.|
|Бизнес-правила|[Экзаменатор](/docs/BusinessRules.md/#WhoIsExaminer), [Тест](/docs/BusinessRules.md/#Testmaking), [Лимит времени](/docs/BusinessRules.md/#TestFlowTimeLimit), [Проведение экзаменов](/docs/BusinessRules.md/#HandlingOfExaminations), [Повторная сдача теста](/docs/BusinessRules.md/#TestFlowAttempts), [Связь сроков экзамена и ограничения времени на тест](/docs/BusinessRules.md/#CalculatingActualTimeLimit)|

|Идентификатор и название варианта использования|UC-3.1.2 Просмотр информации о тесте|
|---|---|
|Основное действующее лицо|Учащийся|
...
|Идентификатор и название варианта использования|UC-3.1.3 Начало тестирования|
|---|---|
|Основное действующее лицо|Учащийся|
...
|Идентификатор и название варианта использования|UC-3.1.4 Просмотр списка вопросов в тесте|
|---|---|
|Основное действующее лицо|Учащийся|
...
|Идентификатор и название варианта использования|UC-3.1.5 Просмотр информации о вопросе|
|---|---|
|Основное действующее лицо|Учащийся|
...
|Идентификатор и название варианта использования|UC-3.1.6 Переход между вопросами|
|---|---|
|Основное действующее лицо|Учащийся|
...
|Идентификатор и название варианта использования|UC-3.1.7 Отправка ответа на вопрос|
|---|---|
|Основное действующее лицо|Учащийся|
...
|Идентификатор и название варианта использования|UC-3.1.8 Отзыв отправленного ответа на вопрос|
|---|---|
|Основное действующее лицо|Учащийся|
...
|Идентификатор и название варианта использования|UC-3.1.9 Досрочное завершение тестирования|
|---|---|
|Основное действующее лицо|Учащийся|
...
|Идентификатор и название варианта использования|UC-3.2.1 Просмотр списка сданных работ|
|---|---|
|Основное действующее лицо|Учащийся|
|Условие-триггер|Пользователь выбирает функцию "Мои работы"|
|Предварительные условия|<ol><li>Пользователь авторизован в системе как учащийся;</li><li>Учащийся может просматривать только свои результаты.</li></ol>|
|Выходные условия|Система выводит постраничный список работ, сданных учащимся.|
|Дополнительно|Список отсортирован по дате сдачи тестирования. Для каждой работы указывается следующая информация: информация о тесте (название, тема, версия), дата сдачи, экзаменатор, статус проверки (проверено или нет), набранный балл, признак "Зачтено" (если набран проходной балл)|
|Бизнес-правила|[Экзаменатор](/docs/BusinessRules.md/#WhoIsExaminer), [Проверка работ](/docs/BusinessRules.md/#CheckingWorks), [Проходной балл](/docs/BusinessRules.md/#TestCheckingPassingScore)|

|Идентификатор и название варианта использования|UC-3.2.2 Просмотр детальной информации об индивидуальных результатах тестирования|
|---|---|
|Основное действующее лицо|Учащийся|
...
### 3.3 Работа с учебными группами
|Идентификатор и название варианта использования|UC-3.3.1 Просмотр списка учебных групп учащегося|
|---|---|
|Основное действующее лицо|Учащийся|
|Условие-триггер|Пользователь выбирает функцию "Мои группы"|
|Предварительные условия|Пользователь авторизован в системе как учащийся.|
|Выходные условия|Система выводит список зарегистрированных учебных групп, в которых состоит учащийся.|
|Дополнительно|Выводятся только действующие группы (не расформированные и обучающиеся в данный момент). Выводится следующая информация о группе: название, статус, сроки обучения, количество учащихся, куратор (если есть)|
|Бизнес-правила|[Учебные группы](/docs/BusinessRules.md/#StudyGroups), [Куратор группы](/docs/BusinessRules.md/#WhoIsCurator)|

## 4 Разные категории пользователей
...
|Дополнительно|<ul><li>По умолчанию вопросы отсортированы по их порядковому номеру;</li><li>Для каждого вопроса в списке указывается: порядковый номер, формулировка, тип и балл.</li><li>Пользователь может фильтровать содержимое списка по следующим критериям:</li><ul><li>Тип вопроса;</li><li>Балл</li><li>Текст (поиск производится: в тексте вопроса, в тексте вариантов ответа (для вопросов с выбором варианта ответа), в тексте правильного ответа (для вопросов с точным ответом в виде строки)).</li></ul><li>Пользователь может сортировать список по следующим критериям:</li><ul><li>Формулировка;</li><li>Тип;</li><li>Балл.</li></ul></ul>|
|Бизнес-правила|[Виды вопросов](/docs/BusinessRules.md/#QuestionTypesList), [Атрибуты вопросов](/docs/BusinessRules.md/#QuestionAttributes)|

|Идентификатор и название варианта использования|UC-4.1.3 Просмотр информации об отдельном вопросе (для составителей)|
|---|---|
|Основное действующее лицо|Преподаватель или администратор|
|Условие-триггер|Пользователь выбирает функцию "Просмотреть вопрос"|
|Предварительные условия|<ol><li>Пользователь авторизован в системе как преподаватель или администратор;</li><li>Пользователь должен быть автором или составителем теста (для администраторов это условие не обязательно).</li></ol>|
|Выходные условия|Система выводит полную информацию о вопросе.|
|Бизнес-правила|[Виды вопросов](/docs/BusinessRules.md/#QuestionTypesList), [Атрибуты вопросов](/docs/BusinessRules.md/#QuestionAttributes)|

### 4.2 Работа с учебными группами
|Идентификатор и название варианта использования|UC-4.2.1 Просмотр списка учебных групп|
|---|---|
|Основное действующее лицо|Преподаватель или администратор|
|Условие-триггер|Пользователь выбирает функцию "Список групп"|
|Предварительные условия|Пользователь авторизован в системе как преподаватель или администратор.|
|Выходные условия|Система выводит постраничный список зарегистрированных учебных групп с возможностью поиска и сортировки.|
|Дополнительно|По умолчанию выводятся только действующие группы (не расформированные и обучающиеся в данный момент). Выводится следующая информация о группе: название, статус, сроки обучения, количество учащихся, куратор (если есть)|
|Бизнес-правила|[Учебные группы](/docs/BusinessRules.md/#StudyGroups), [Обработка данных о группах](/docs/BusinessRules.md/#WhoCanWorkWithGroups), [Куратор группы](/docs/BusinessRules.md/#WhoIsCurator), [Уникальность учебных групп](/docs/BusinessRules.md/#GroupUniqueness)|

|Идентификатор и название варианта использования|UC-4.2.2 Просмотр списка студентов, состоящих в группе|
|---|---|
|Основное действующее лицо|Преподаватель, администратор или учащийся, состоящий в данной группе|
|Условие-триггер|Пользователь выбирает функцию "Состав группы"|
|Предварительные условия|Пользователь авторизован в системе как преподаватель или администратор, либо пользователь авторизован в системе как учащийся, который является членом данной группы.|
|Выходные условия|Система выводит список учащихся, состоящих в группе, отсортированный по алфавиту.|
|Бизнес-правила|[Учебные группы](/docs/BusinessRules.md/#StudyGroups)|

|Идентификатор и название варианта использования|UC-4.2.3 Просмотр подробной информации об учебной группе|
|---|---|
|Основное действующее лицо|Преподаватель, администратор или учащийся, состоящий в данной группе|
|Условие-триггер|Пользователь выбирает функцию "Информация о группе"|
|Предварительные условия|Пользователь авторизован в системе как преподаватель или администратор, либо пользователь авторизован в системе как учащийся, который является членом данной группы.|
|Выходные условия|Система выводит подробную информацию об учебной группе: <ul><li>Наименование;</li><li>Статус (расформирована или активна);</li><li>Срок обучения;</li><li>Куратор (если есть).</li></ul>|
|Бизнес-правила|[Учебные группы](/docs/BusinessRules.md/#StudyGroups)|


### 4.3 Работа с результатами тестирования
|Идентификатор и название варианта использования|UC-4.3.1 Просмотр списка работ учащихся|
|---|---|
|Основное действующее лицо|Преподаватель или администратор|
|Условие-триггер|Пользователь выбирает функцию "Сданные работы"|
|Предварительные условия|Пользователь авторизован в системе как преподаватель или администратор.|
|Выходные условия|Система выводит постраничный список всех сданных работ учащихся с возможностью фильтрации и сортировки.|
|Дополнительно|<ul><li>По умолчанию выводятся непроверенные работы;</li><li>Если пользователь не авторизован как администратор, то список автоматически отфильтрован по тем работам, к которым пользователь имеет доступ как экзаменатор;</li>По каждой работе выводится следующая информация: ФИО учащегося, учебная группа, сведения о тесте (название, тема, версия), номер попытки, экзаменатор, когда сдана работа, статус проверки (проверена или нет), тип проверки (ручная/автоматическая/смешанная)</ul>|
|Бизнес-правила|[Экзаменатор](/docs/BusinessRules.md/#WhoIsExaminer), [Проверка работ](/docs/BusinessRules.md/#CheckingWorks), [Учёт повторных попыток](/docs/BusinessRules.md/#AttemptsLogging)|

### 4.4 Работа с экзаменами
|Идентификатор и название варианта использования|UC-4.4.1 Перенос сроков экзамена **TBD**|
|---|---|
|Основное действующее лицо|Преподаватель или администратор|
...
|Идентификатор и название варианта использования|UC-4.4.2 Отмена экзамена|
|---|---|
|Основное действующее лицо|Преподаватель или администратор|
...
|Идентификатор и название варианта использования|UC-4.4.3 Просмотр общего расписания экзаменов|
|---|---|
|Основное действующее лицо|Преподаватель или администратор|
|Условие-триггер|Пользователь выбирает функцию "Расписание экзаменов"|
|Предварительные условия|Пользователь авторизован в системе как преподаватель или администратор.|
|Выходные условия|Система выводит постраничный список экзаменов по всем тестам с возможностью фильтрации, поиска и сортировки содержимого.|
|Дополнительно|<ul><li>По умолчанию прошедшие экзамены не выводятся, только запланированые и текущие;</li><li>Можно отфильтровать расписание:</li><ul><li>По куратору учебных групп;</li><li>По экзаменатору;</li><li>По тесту;</li><li>По набору групп;</li><li>По времени.</li></ul></ul>|
|Бизнес-правила|[Проведение экзаменов](/docs/BusinessRules.md/#HandlingOfExaminations), [Учебные группы](/docs/BusinessRules.md/#StudyGroups), [Экзаменатор](/docs/BusinessRules.md/#WhoIsExaminer), [Куратор группы](/docs/BusinessRules.md/#WhoIsCurator)|

|Идентификатор и название варианта использования|UC-4.4.4 Просмотр детальной информации по экзамену|
|---|---|
|Основное действующее лицо|Преподаватель или администратор|
|Условие-триггер|Пользователь выбирает функцию "Информация об экзамене"|
|Предварительные условия|Пользователь авторизован в системе как преподаватель или администратор.|
|Выходные условия|Система выводит подробную информацию об экзамене.|
|Дополнительно|Выводится следующая информация: <ul><li>Сведения о тесте (название, тема, версия);</li><li>Настройки теста (оценивание, процедура тестирования);</li><li>Количество вопросов;</li><li>Сроки проведения экзамена;</li><li>Список групп, сдающих экзамен;</li><li>Информация об экзаменаторе;</li><li>Процент учащихся от общего числа экзаменуемых, которые прошли тест.</li></ul>|
|Бизнес-правила|[Проведение экзаменов](/docs/BusinessRules.md/#HandlingOfExaminations), [Учебные группы](/docs/BusinessRules.md/#StudyGroups), [Экзаменатор](/docs/BusinessRules.md/#WhoIsExaminer), [Тест](/docs/BusinessRules.md/#Testmaking)|

## 5. Все пользователи
### 5.1 Работа с личной учётной записью
|Идентификатор и название варианта использования|UC-5.1.1 Смена пароля|
|---|---|
...
<!--ToDo добавить в правила понятие личного кабинета, описать его содержание и назначение-->
|Идентификатор и название варианта использования|UC-5.1.2 Просмотр информации о личной учётной записи|
|---|---|
|Основное действующее лицо|Любой пользователь системы.|
|Условие-триггер|Пользователь выбирает функцию "Личный кабинет".|
|Предварительные условия|У пользователя есть незаблокированная учётная запись в системе.|
|Выходные условия|Система выводит информацию о профиле пользователя в системе.|
|Дополнительно|Пользователю доступна следующая информация:<ul><li>ФИО;</li><li>E-mail;</li><li>Статус временного пароля (сменён или нет);</li><li>Текущие роли доступа.</li></ul>|
|Бизнес-правила||

## 6. Автоматические операции
### 6.1 Работа с результатами тестирования
|Идентификатор и название варианта использования|UC-6.1.1 Автоматическая проверка работ|
|---|---|
...
### 6.2 Работа с учётными записями пользователей
|Идентификатор и название варианта использования|UC-6.2.1 Блокировка учётной записи пользователя по истечении срока действия временного пароля|
|---|---|
|Основное действующее лицо|Система AlphaTest|
