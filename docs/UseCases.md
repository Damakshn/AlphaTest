...
|Идентификатор и название варианта использования|UC-1.1.14 Создание новой редакции теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.15 Настройка способа проверки работ|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.16 Настройка распределения баллов за вопросы|
|---|---|
|Основное действующее лицо|Преподаватель|
|Условие-триггер|Пользователь выбирает функцию "Настроить режим проверки"|
|Предварительные условия|<ol><li>Пользователь авторизован в системе как преподаватель;</li><li>Пользователь должен быть автором или составителем теста.</li></ol>|
