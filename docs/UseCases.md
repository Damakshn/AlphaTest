...
|Бизнес-правила|_Добавить: автор теста, уникальность теста, начальный статус теста, версионирование тестов_|
...
|Бизнес-правила|_Добавить: уникальность теста, ограничения, связанные с ожиданием публикации_|
...
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|_Добавить: публикация, порядок прохождения вопросов_|
...
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|_Добавить: публикация, повторные ответы - допустимые значения_|
...
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|_Добавить: лимит времени, лимит времени - диапазон допустимых значений, публикация_|
...
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|_Добавить: попытки сдачи теста, попытки сдачи теста - диапазон допустимых значений, публикация_|
...
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|_Добавить: публикация, политика оценивания_|
...
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|_Добавить: проходной балл, публикация_|

|Идентификатор и название варианта использования|UC-1.1.9 Задание возможности завершать тестирование досрочно|
|---|---|
|Основное действующее лицо|Преподаватель|
|Условие-триггер|Пользователь выбирает функцию "Настроить досрочное завершение теста"|
|Предварительные условия|<ol><li>Пользователь авторизован в системе как преподаватель;</li><li>Пользователь должен быть автором или составителем теста.</li></ol>|
|Выходные условия|Досрочное завершение теста разрешается/запрещается.|
|Нормальное направление|<ol><li>Пользователь выбирает функцию "Настроить досрочное завершение теста";</li><li>Система предлагает выбрать, разрешить или запретить досрочное заверешние теста учащимся;</li><li>Пользователь выбирает нужный вариант;</li><li>Пользователь указывает, что редактирование завершено;</li><li>Система сохраняет изменения в базе данных.</li></ol>|
|Исключения||
||**Другой пользователь, имеющий права на редактирование теста, уже внёс изменения и возник конфликт правок**|
||Система выводит пользователю сообщение об ошибке и предлагает попытаться снова.|
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|_Добавить: досрочное завершение, публикация_|
...
|Бизнес-правила|_Добавить: минимальные требования к тесту, заявка на публикацию, обработка заявок, публикация, статус теста_|
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|_Добавить: вопросы, типы вопросов, публикация, нумерация добавленных вопросов, ограничения для вопросов разных типов, совместимость вопросов разных типов с определёнными настройками теста_|
...
||**Тест находится в ожидании публикации**|
||Система выводит пользователю сообщение о невозможности редактировать тест в данный момент.|
|Бизнес-правила|_Добавить: публикация, удаление вопросов, нумерация вопросов при удалении_|
...
||Система выводит пользователю сообщение об ошибке и предлагает попытаться снова.|
|Бизнес-правила|_Добавить: публикация, перестановка вопросов, сдвиг вопросов при перестановке_|
...
||**Другой пользователь, имеющий права на редактирование теста, уже изменил вопрос и возник конфликт правок**|
||Система выводит пользователю сообщение об ошибке и предлагает попытаться снова.|
|Бизнес-правила|_Добавить: публикация, формулировка вопроса, максимальная длина текста для вопроса_|

|Идентификатор и название варианта использования|UC-1.1.15 Отправка теста в архив|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Идентификатор и название варианта использования|UC-1.1.16 Создание новой редакции теста|
|---|---|
|Основное действующее лицо|Преподаватель|
...
|Бизнес-правила|_Добавить: публикация, новая редакция, списание в архив, проведение экзаменов, проверка работ_|

|Идентификатор и название варианта использования|UC-1.1.17 Настройка способа проверки работ|
|---|---|
|Основное действующее лицо|Преподаватель|
...
||Система выводит пользователю сообщение о недопустимой операции.|
|Бизнес-правила|_Добавить: публикация, проверка работ, способы проверки_|

|Идентификатор и название варианта использования|UC-1.1.18 Настройка распределения баллов за вопросы|
|---|---|
|Основное действующее лицо|Преподаватель|
|Условие-триггер|Пользователь выбирает функцию "Настроить режим проверки"|
|Предварительные условия|<ol><li>Пользователь авторизован в системе как преподаватель;</li><li>Пользователь должен быть автором или составителем теста.</li></ol>|
...
||Система выводит пользователю сообщение о недопустимой операции.|
|Бизнес-правила|_Добавить: публикация, распределение баллов_|
...
|Бизнес-правила|_Добавить: автор теста, составитель теста, добавить составителя_|
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|_Добавить: автор теста, составители, исключение составителя автором_|
...
|Бизнес-правила|_Добавить: автор теста, передача теста_|
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|_Добавить: назначение экзамена, группы, сдающие экзамен, сроки проведения экзамена, связь сроков экзамена и ограничения времени на тест, перекрывающиеся экзамены_|

|Идентификатор и название варианта использования|UC-1.3.2 Перенос сроков экзамена|
|---|---|
...
|Бизнес-правила|_Добавить: группы, сдающие экзамен, сроки проведения экзамена, связь сроков экзамена и ограничения времени на тест, изменение срока в момент сдачи теста учащимися, перекрывающиеся экзамены_|
...
|Бизнес-правила|_Добавить: группы, сдающие экзамен, отмена экзамена, отмена экзамена в процессе сдачи теста учащимися, аннулирование результатов отменённого экзамена_|
...
|Бизнес-правила|_Добавить: проверка работ, ручная оценка_|
...
|Бизнес-правила|_Добавить: ручная оценка, политика оценивания, алгоритм подсчёта итогового балла, вердикты при оценивании, допустимые значения для баллов_|
...
|Бизнес-правила|_Добавить: пользователь, данные пользователя, уникальность пользователей, вход в систему, роли доступа, временный пароль, блокировка после истечения срока действия временного пароля_|
...
|Бизнес-правила|_Добавить: уникальность пользователя, массовый импорт, учебные группы, добавление в группу, отчёт о результатах импорта_|

|Идентификатор и название варианта использования|UC-2.1.3 Назначение ролей доступа для пользователей|
|---|---|
|Основное действующее лицо|Администратор|
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|_Добавить: роли доступа, сочетание ролей_|
...
||Система выводит пользователю сообщение о недопустимой операции.|
|Бизнес-правила|_Добавить: блокировка пользователя, блокировка преподавателя, блокировка автора теста, блокировка составителя теста, блокировка экзаменатора, блокировка учащегося, блокировка администратора_|
...
|Бизнес-правила|_Добавить: временный пароль, блокировка после истечения срока действия временного пароля_|
...
||Система выводит пользователю сообщение о недопустимой операции.|
|Бизнес-правила|_Добавить: блокировка пользователя, блокировка автора теста, передача авторства администратором_|
...
||Система выводит пользователю сообщение о недопустимой операции.|
|Бизнес-правила|_Добавить: блокировка экзаменатора, передача полномочий экзаменатора_|
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|_Добавить: Учебная группа, кураторы, уникальность групп_|
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|_Добавить: Учебная группа, членство в группах_|
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|_Добавить: Учебная группа, членство в группах, исключение из группы_|
...
|Бизнес-правила|_Добавить: куратор группы_|
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|_Добавить: Расформирование группы, срок жизни группы_|
...
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|_Добавить: Уникальность групп_|
...
|Нормальное направление|<ol><li>Администратор выбирает заявку на публикацию в списке и применяет к ней функцию "Обработать";</li><li>Система закрепляет выбранную заявку за текущим пользователем;</li><li>Система изменяет статус теста, для которого отправлена заявка на "Заявка рассматривается";</li><li>Система сохраняет изменения в базе данных.</li></ol>|
|Бизнес-правила|_Добавить: обработка заявок, заявка на публикацию, отслеживание заявки, статус теста_|
...
|Бизнес-правила|_Добавить: обработка заявок, заявка на публикацию, статус теста_|
...
|Бизнес-правила|_Добавить: список экзаменов, информация о тесте перед экзаменом, начало тестирования_|
...
|Бизнес-правила|_Добавить: регистрация попыток, лимит времени на тест, определение следующего вопроса, порядок прохождения вопросов_|
...
|Бизнес-правила|_Добавить: список вопросов для учащегося_|
...
||Система выводит пользователю сообщение о том, что время вышло.|
|Бизнес-правила|_Добавить: информация о вопросе, порядок прохождения вопросов_|
...
|Альтернативное направление - вопросы закончились и повторная отправка ответов разрешена|<ol><li>Пользователь ответил на последний оставшийся вопрос;</li><li>Система выводит сообщение о том, что тестирование завершено и предлагает просмотреть отправленные ответы ещё раз; если составитель разрешил досрочное завершение, то система предлагает также возможность завершить тестирование.</li></ol>|
|Исключения||
||**Доступ к вопросу закрыт, так составитель запретил произвольный порядок ответов на вопросы**|
||Система выводит пользователю сообщение об ошибке и предлагает ответить на следующий по порядку вопрос.|
||**Доступ к вопросу закрыт, так как время, отведённое для сдачи теста, уже вышло**|
...
||Система выводит пользователю сообщение об отказе в доступе.|
|Бизнес-правила|_Добавить: Определение следующего вопроса, порядок прохождения вопросов, завершение тестирования, повторная отправка_|
...
|Бизнес-правила|_Добавить: повторная отправка ответа, лимит времени, валидация ответа_|
...
|Бизнес-правила|_Добавить: повторная отправка ответов, отзыв ответов_|
...
|Исключения||
||**Досрочное завершение запрещено составителем**|
||Система выводит пользователю сообщение об ошибке.|
|Бизнес-правила|_Добавить: завершение тестирования_|
...
|Бизнес-правила|_Добавить: проверка работ, оценка ответов, проходной балл, отчёт о результатах для учащегося_|
...
|Бизнес-правила|_Добавить: постоянный пароль пользователя_|
...
|Бизнес-правила|_Добавить: проверка работ, оценка ответов, политика оценивания_|
...
|Бизнес-правила|_Добавить: временный пароль, срок действия временного пароля_|
